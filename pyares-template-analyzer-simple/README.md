# Pyares Simple Analyzer Template
## Introduction
This is a template for a a simple, single file [PyAres](https://github.com/AFRL-ARES/PyAres) Analyzer service. This approach is best for getting started with PyAres or if your anaysis protocol is relatively simple and doesn't require a lot of custom logic that isn't already abstracted away by external libraries. 

## Using this Template
1. Clone this repository to your local machine.
2. Edit `requirements.txt` to specify the any dependencies for your analyzer. These can then be installed using pip with by running `pip install -r requirements.txt` from the parent directory.
3. Edit `start_simple_analyzer.py` to customize your analyzer.
4. Run your analyzer with `python start_simple_analyzer.py` from within the parent directory.
