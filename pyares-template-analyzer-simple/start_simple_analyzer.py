...
from PyAres import (AresAnalyzerService, # Required for the Service
                    Analysis, AnalysisRequest, AresDataType,Outcome) 
...
def analyzer(request: AnalysisRequest) -> Analysis:
    try:
        ...
        analysis = Analysis(result=ouput_value, outcome=Outcome.SUCCESS)

    except Exception as e:
        analysis = Analysis(result=-1, outcome=Outcome.FAILURE)
